...
/*0x0*/ static DLTri dLaserTris[] = {
    MASK_TRI(0x40, 0x00, 0x01, 0x04), 
    MASK_TRI(0x40, 0x01, 0x05, 0x04),
    MASK_TRI(0x40, 0x02, 0x00, 0x04), 
    MASK_TRI(0x40, 0x04, 0x06, 0x02), 
    MASK_TRI(0x40, 0x03, 0x02, 0x06), 
    MASK_TRI(0x40, 0x06, 0x07, 0x03), 
    MASK_TRI(0x40, 0x01, 0x03, 0x07), 
